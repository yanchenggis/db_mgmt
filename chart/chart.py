...
def plot_counts(df, column, top_n=20, chart_type='auto', output=None):
...
def plot_x_vs_y(df, x, y, chart_type='auto', output=None):
...
def main():
    ...
    if args.column:
        plot_counts(df, args.column, args.top_n, args.chart_type, args.output)
    elif args.x and args.y:
        plot_x_vs_y(df, args.x, args.y, args.chart_type, args.output)
    else:
